...
export function TecnicoContratacion({ t, onBookDemo }: { t: any, onBookDemo: () => void }) {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="min-h-screen pt-20">
        ...
        <div className="max-w-7xl mx-auto bg-gradient-to-br from-[#f0f9ff] to-[#ecfeff] dark:from-slate-900/70 dark:to-slate-800/70 border border-slate-300 dark:border-slate-700 rounded-xl p-8">
          ...
          <div className="space-y-4">
            {workModel.map((item, i) => (
              <div key={i} className="grid md:grid-cols-12 gap-4 items-start p-5 bg-gradient-to-r from-white/90 to-slate-100/80 dark:from-slate-800/60 dark:to-slate-700/50 border border-slate-300 dark:border-slate-700 rounded-lg">
        ...
        <div className="max-w-7xl mx-auto bg-gradient-to-br from-[#eff6ff] to-[#f8fafc] dark:from-slate-900/70 dark:to-slate-800/70 border border-slate-300 dark:border-slate-700 rounded-xl p-8">
          ...
          <div className="space-y-3">
            {deliverables.map(([title, desc], i) => (
              <div key={i} className="grid md:grid-cols-12 gap-4 p-4 border border-slate-300 dark:border-slate-700 rounded-lg bg-gradient-to-r from-white/95 to-slate-100/80 dark:from-slate-800/60 dark:to-slate-700/50">
      ...
      <section className="py-8 px-4">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-[#f5f3ff] to-[#f8fafc] dark:from-slate-900/70 dark:to-slate-800/70 border border-slate-300 dark:border-slate-700 rounded-xl p-8">
          ...
          <div className="bg-gradient-to-br from-[#fef2f2] to-[#fff7ed] dark:from-slate-900/70 dark:to-slate-800/70 border border-slate-300 dark:border-slate-700 rounded-xl p-8">
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-[#ede9fe] to-[#e0f2fe] dark:from-slate-900/70 dark:to-slate-800/70 border border-slate-300 dark:border-slate-700 rounded-xl p-10">
          ...
          <div className="flex justify-center">
            <button onClick={onBookDemo} className="px-8 py-4 rounded-xl font-bold inline-flex items-center gap-2">
